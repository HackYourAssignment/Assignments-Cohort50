...
function selectRandomly(array) {
  const randomSelectedElement = Math.floor(Math.random()* array.length);
    return array[randomSelectedElement];
...
function main() {
  ...
  const partnerNames = ['Ali', 'Mohammed', 'Saeed', "Akram", 'Gaith'];

  const locations = ['Netherlad', 'france', 'Qatar', 'Japan', 'Canada'];

  const jobTitles = ['programer', 'photographer', 'Doctor', 'engineer', 'businessman'];
