...
const hourlyEarnings = (arrayOfTasks.map((task)=>{return (task.duration/60)*hourlyRate})).reduce((total,hourlyEarning)=>total + hourlyEarning);
return ("€"+hourlyEarnings.toFixed(2));
